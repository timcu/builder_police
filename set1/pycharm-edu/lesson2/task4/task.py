...
node_dict.update(set_node(15, 20, 10, "default:wood"))
print("A:", node_dict)

# Set block at x=16, y=20, z=10 to "default:glass"
node_dict.update(set_node(16, 20, 10, "default:glass"))
print("B:", node_dict)

# Set two blocks at x=16, y=20, z=10 and z=11 to "default:stone"
for z in range(10,12):
    node_dict.update(set_node(16, 20, z, "default:stone"))
print("C:", node_dict)
...
node_dict.update(set_node(x, y, z, "wool:blue"))
print("D:", node_dict)
